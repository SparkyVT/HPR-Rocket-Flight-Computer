...
void setup(void) {
 ...
 while (SD.exists(dataString)) {
  ...
  outputFile.print(F(","));
  outputFile.println(F("gTm,aX,aY,aZ,gX,gY,gZ,rotnZ,rotnY,rotnX,offVert,vel,alt,events,cont,fire,pin,highGx,Alt,press,temp,magX,magY,magZ,lat,lon,speed,gps_alt,gps_angle,satellites,packet"));
  outputFile.sync();
