...
//20Hz of LoRa telemetry output (time, event, acceleration, speed, altitude, rotation, GNSS alt, GNSS position, packet number)
//10Hz-75Hz of GNSS data logging (chip dependent data rates & constellations)
...
//User selectable active stabilization for roll, pitch, and yaw correction (in the works)
//-------FUTURE UPGRADES----------
...
//Smartphone App
//------TO DO LIST------
//433MHz FHSS capability
//Auto-calibration for baro sensors
//Test MS5611 code
//Correct DCM2D code for use with active stabilization
...
typedef struct{
    ...
    int inflightRecover = 128;
    int fireTime = 129;//4
    int pyro4Func = 133;
    int pyro3Func = 134;
    int pyro2Func = 135;
    int pyro1Func = 136;
    int radioTXenable = 137;
    int TXpwr = 138;
    int TXfreq = 139;//4
    int FHSS = 143;
    int boosterSeparationDelay = 144;//4
    int sustainerFireDelay = 148;//4
    int airStart1Event = 152;
    int airStart1Delay = 153;//4
    int airStart2Event = 157;
    int airStart2Delay = 158;//4
    int altThreshold = 162;//2
    int maxAngle = 164;
    int stableRotn = 165;
    int stableVert = 166;
    int flyback = 167;
...
inline void getRotn(void) __attribute__((always_inline));
