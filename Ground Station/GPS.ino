...
void restoreGPSdefaults(){
  ...
  if (gpsSetSuccess == 3){Serial.println("Restore factory defaults failed!");}}
...
//  gpsSetSuccess = 0;
  ...
  if (gpsSetSuccess == 3){Serial.println("NMEA 4.1 Message Activation Failed!");}
  gpsSetSuccess = 0;
  ...
  if (gpsSetSuccess == 3){Serial.println("Satellite Settings Failed!");}
  gpsSetSuccess = 0;
  ...
  if (gpsSetSuccess == 3){Serial.println("Interference Settings Failed!");}
  gpsSetSuccess = 0;
...
void GPSpowerSaveMode(){
  ...
  if (gpsSetSuccess == 3){Serial.println("Config GNSS Message Failed!");}
  gpsSetSuccess = 0;
  ...
  if (gpsSetSuccess == 3){Serial.println("Config PSM Message Failed!");}
  gpsSetSuccess = 0;
  ...
  if (gpsSetSuccess == 3){Serial.println("Commit PSM Message Failed!");}
  gpsSetSuccess = 0;
