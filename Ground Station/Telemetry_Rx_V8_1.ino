//Sketch uses 28414 bytes (99%) of program storage space. Maximum is 28672 bytes.
//Global variables use 1606 bytes of dynamic memory.
//732 lines of code
...
volatile byte chnl = 0;
float radioFreq[8] = {433.500, 433.625, 433.750, 433.875, 434.000, 434.125, 434.250, 434.400};
...
void loop() {
  ...
  /*if(micros()-timer > 1000000UL){
    ...
    if(!SDinit){Serial1.println(F("SD card failed"));}
    timer = micros();
    if(!radioSetup){Serial1.println(F("Radio Failed"));}
    }*/
