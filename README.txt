...
--Create your own custom board with configurable pins for continuity, firing, and servos
...
Note: Estimated Flight Computer Cost = $155
Note: Estimated Ground Station Cost = $120 (does not include antenna)
